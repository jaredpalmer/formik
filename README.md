...
- [API](#api)
  - [`<Formik />`](#formik-)
    ...
    - [`validate?: (values: Values, touched: { [field: string]: boolean }) => FormikError<Values> | Promise<any>`](#validate-values-values-touched--field-string-boolean---formikerrorvalues--promiseany)
  ...
  - [`withFormik(options)`](#withformikoptions)
    - [`options`](#options)
      ...
      - [`validate?: (values: Values, props: Props, touched: { [field: string]: boolean }) => FormikError<Values> | Promise<any>`](#validate-values-values-props-props-touched--field-string-boolean---formikerrorvalues--promiseany)
...
#### `validate?: (values: Values, touched: { [field: string]: boolean }) => FormikError<Values> | Promise<any>`
...
##### `validate?: (values: Values, props: Props, touched: { [field: string]: boolean }) => FormikError<Values> | Promise<any>`
