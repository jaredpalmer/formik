...
var Field = (function (_super) {
    ...
    Field.prototype.componentWillMount = function () {
        warning_1$2(!(typeof this.props.component !== 'string' && this.props.render), 'You should not use <Field component> and <Field render> in the same <Field> component; <Field component> will be ignored');
        warning_1$2(!(typeof this.props.component !== 'string' &&
            this.props.children &&
            !isEmptyChildren(this.props.children)), 'You should not use a non-string <Field component> and <Field children> in the same <Field> component; <Field component> will be ignored.');
        warning_1$2(!(this.props.render &&
            this.props.children &&
            !isEmptyChildren(this.props.children)), 'You should not use <Field render> and <Field children> in the same <Field> component; <Field children> will be ignored');
    };
    Field.prototype.render = function () {
        var _a = this
            .props, component = _a.component, render = _a.render, children = _a.children, name = _a.name, props = __rest(_a, ["component", "render", "children", "name"]);
        ...
        if (typeof component === 'string') {
            return React.createElement(component, __assign({}, field, props));
        }
...
var Form = function (props, context) {
    return React.createElement("form", __assign({ onSubmit: context.formik.handleSubmit }, props));
};
Form.contextTypes = {
    formik: index_1,
};
        ...
        var C = (function (_super) {
            ...
            function C() {
                ...
                _this.renderFormComponent = function (formikProps) {
                    return React.createElement(Component$$1, __assign({}, _this.props, formikProps));
                };
                return _this;
            }
    ...
    function Formik(props) {
        ...
        _this.handleChange = function (e) {
            ...
            _this.setState(function (prevState) {
                return (__assign({}, prevState, { values: __assign({}, prevState.values, (_a = {}, _a[field] = val, _a)), touched: __assign({}, prevState.touched, (_b = {}, _b[field] = true, _b)) }));
                var _a, _b;
            });
            if (_this.props.validateOnChange) {
