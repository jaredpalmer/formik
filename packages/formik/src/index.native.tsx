...
//
// The Native compiler will detect this file with a .native suffix, and inject it in place of index.js,
// assigning unstable_batchedUpdates from 'react-native' instead of 'react-dom'
//
