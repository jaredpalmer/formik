...
import { createValidator, constraintsHaveChanged } from './fieldConstraints';
...
> {
  ...
  componentDidMount() {
    ...
    this.context.registerField(this.props.name, {
      validate: createValidator(this.props.name, this.props),
    });
  }
  ...
  componentDidUpdate(prevProps: FastFieldAttributes<Props>) {
    ...
    if (constraintsHaveChanged(this.props, prevProps)) {
      this.context.registerField(this.props.name, {
        validate: createValidator(this.props.name, this.props),
      });
    }
