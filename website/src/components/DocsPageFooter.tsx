        ...
        <div className="space-y-8 md:flex space-between items-center md:space-y-0 md:space-x-8">
          {prevRoute && prevRoute.path ? (
            (<NextLink
              ...
              className="flex-1 max-w-md block border border-gray-200 p-4 rounded-lg betterhover:hover:text-blue-600 duration-150 ease-out">
          ...
          {nextRoute && nextRoute.path ? (
            (<NextLink
              ...
              className="flex-1 max-w-md text-right block border border-gray-200  p-4 rounded-lg betterhover:hover:text-blue-600 duration-150 ease-out">
