    ...
    <div className="bg-gray-50 h-full">
      ...
      <div className="relative bg-white overflow-hidden">
        ...
        <div className="py-24 mx-auto container px-4 sm:mt-12  relative">
          <img
            className="hidden lg:block absolute lg:w-3/5 right-0 lg:-rotate-30    lg:translate-x-1/3 lg:-translate-y-16 md:w-1/2 sm:w-2/3 top-0  transform  -translate-y-12"
            src="/hero6.png"
            alt="Formik Forms"
          />
              ...
              <div className="mt-10 lg:mt-0">
                <div>
                  ...
                  <p className="mt-2  lg:mt-4 text-lg lg:leading-normal leading-6 text-gray-600">
                    ...
                    testing, and reasoning about your forms a breeze. If you
                    know React, and you know a bit about forms, you know Formik!
                  </p>
                </div>
              </div>
              <div className="mt-10 lg:mt-0">
                <div>
                  ...
                  <p className="mt-2  lg:mt-4 text-lg lg:leading-normal leading-6 text-gray-600">
                    ...
                    and keeps bundle size to a minimum.
                  </p>
                </div>
              </div>
            </div>
